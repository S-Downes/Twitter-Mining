...
# Get the diversity of tweets and the average words for our variables created above 

def get_lexical_words(items):
...
print("Word Diversity: {0}".format(get_lexical_words(words)))
print("Screen Name Diversity: {0}".format(get_lexical_words(screen_names)))
print("Hashtag Diversity: {0}".format(get_lexical_words(hashtags)))
